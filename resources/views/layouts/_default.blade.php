...
<head>
    ...
    <!-- Title -->
    <title>{{ isset($title) ? $title .' | ':' ' }} Kalinda & Asscociés</title>
          ...
          <div id="searchDropdownMenu" class="hs-form-search-menu-content card dropdown-menu dropdown-card overflow-hidden">
            ...
            <div class="card-body-height py-3">
              ...
              <div class="dropdown-item bg-transparent text-wrap my-2">
                <span class="h4 mr-1">
                  <a class="btn btn-xs btn-soft-dark btn-pill" href="{{ Route('home') }}">
            ...
            <!-- Footer -->
            <a class="card-footer text-center" href="{{ Route('home') }}">
              See all results
        ...
        <ul class="navbar-nav flex-grow-1">
          ...
          <li class="hs-has-sub-menu">
            ...
            <ul id="navLinkPagesDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="pagesDropdown" style="min-width: 16rem;">
              ...
              <!-- Welcome Page -->
              <li>
                <a class="dropdown-item" href="{{ route('dossier') }}">
          ...
          <li class="hs-has-sub-menu">
            ...
            <ul id="navLinkappsNavDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="appsNavDropdown" style="min-width: 16rem;">
              <li>
                <a class="dropdown-item" href=" {{ route('avocat') }}">
                  <span class="tio-circle nav-indicator-icon"></span> Apercu
                </a>
              </li>
              <li>
          ...
          <!-- Layouts -->
          <li>
            <a class="navbar-nav-link nav-link" href="{{ Route('client') }}">
          ...
          <li class="hs-has-sub-menu">
            ...
            <ul id="navLinkDocumentationDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg" aria-labelledby="documentationDropdown" style="min-width: 16rem;">
              <li>
                <a class="dropdown-item" href="documentation/{{ Route('home') }}">
        ...
        <ul class="navbar-nav navbar-nav-lg nav-tabs">
          ...
          <li class="navbar-vertical-aside-has-menu show">
            ...
            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
              <li class="nav-item">
                <a class="nav-link active" href="{{ Route('home') }}" title="Default">
          ...
          <li class="navbar-vertical-aside-has-menu ">
            ...
            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
              <li class="nav-item">
                <a class="nav-link " href="{{ route('avocat') }}" title="Kanban">
                  <span class="tio-circle nav-indicator-icon"></span>
                  <span class="text-truncate">Aperçue</span>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item ">
            <a class="js-nav-tooltip-link nav-link" href="documentation/{{ Route('home') }}" title="Documentation" data-placement="left">
    ...
    <div class="navbar-vertical-content">
      <ul class="navbar-nav nav-compact">
        ...
        <li class="navbar-vertical-aside-has-menu nav-item">
          ...
          <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
            <li class="nav-item">
              <a class="nav-link " href="{{ Route('home') }}" title="Default">
                <span class="tio-circle nav-indicator-icon"></span>
                <span class="text-truncate">Default</span>
              </a>
            </li>
        ...
        <li class="navbar-vertical-aside-has-menu nav-item">
          ...
          <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
            <li class="nav-item">
              <a class="nav-link " href="{{ route('avocat') }}" title="Kanban">
                <span class="tio-circle nav-indicator-icon"></span>
                <span class="text-truncate">Apercu</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="apps-invoice-generator.html" title="Invoice generator">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{ Route('client') }}" title="Layouts">
            <i class="tio-dashboard-vs-outlined nav-icon"></i>
        ...
        <li class="nav-item ">
          <a class="nav-link" href="documentation/{{ Route('home') }}" title="Documentation">
            <i class="tio-book-opened nav-icon"></i>
